...
#from scipy.stats import Jacardr
...
print " Ext_jacard   Coefficient Correlation between 2 books:->"
b1 = raw_input("Enter the name of the first book:\t")
b2 = raw_input("Enter the name of the second book:\t")
if(b1 != b2):
                print "Jacard Correlation Coefficient between '",b1,"' and '",b2,"' =",calculate_correlation(b1, b2)
                common = common_reviewers(b1, b2)
                print "%d people have reviewed these 2 books" %len(common)
                print common
else:
                print "Jacard Correlation Coefficient between same book is always 1.0"
nl()
